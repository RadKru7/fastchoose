...
answers_db = {
    ...
    503: {'question_id': 5, 'next_question_id': 9, 'en': 'Versatile rear camera (e.g., for landscapes, portraits)', 'es': 'Cámara trasera versátil (p. ej., para paisajes, retratos)', 'pl': 'Wszechstronny tylny aparat', 'icon_path': 'icons/camera_rear.svg'},
   ...
   701: {'question_id': 7, 'next_question_id': 8, 'en': 'I need the highest possible performance', 'es': 'Necesito el máximo rendimiento posible', 'pl': 'Potrzebuję najwyższej wydajności', 'icon_path': 'icons/performance_high.svg'},
    ...
    801: {'question_id': 8, 'next_question_id': None, 'en': 'Android', 'es': 'Android', 'pl': 'Android', 'icon_path': 'icons/android.svg'},
    802: {'question_id': 8, 'next_question_id': None, 'en': 'iOS', 'es': 'iOS', 'pl': 'iOS', 'icon_path': 'icons/apple.svg'},
