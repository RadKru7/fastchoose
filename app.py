...
answers_x_products = {
    ...
    102: [211, 210, 216, 249, 244, 212, 209, 251, 250, 245, 246, 248, 218, 241, 247, 243, 242, 246, 240, 238, 239, 202, 203, 201, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 253, 252, 268, 269, 270, 271, 272, 273, 274, 275, 276],

    # 103: Najdroższe telefony
    # Algorytm: Telefony posortowane malejąco po cenie – najdroższy jako pierwszy, najtańszy jako ostatni.
    103: [243, 239, 248, 238, 253, 252, 240, 246, 242, 247, 241, 218, 246, 245, 201, 203, 202, 244, 249, 216, 211, 210, 212, 209, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 217, 270, 271, 272, 273, 274, 275, 276],
    ...
    202: [239, 248, 247, 218, 243, 253, 252, 202, 246, 211, 201, 203, 210, 241, 240, 238, 242, 212, 249, 244, 216, 245, 209, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 217, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276],

    # 203: Gry (wydajność)
    # Algorytm: Telefony z najmocniejszym procesorem, najlepszym GPU, dużą pamięcią RAM i szybkim ekranem na początku listy.
    203: [239, 248, 238, 240, 246, 202, 241, 218, 211, 201, 203, 210, 242, 243, 247, 212, 249, 244, 216, 245, 253, 252, 209, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 217, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276],

    # 301: Bateria bardzo ważna
    # Algorytm: Telefony z największą pojemnością baterii i najlepszą optymalizacją na początku listy.
    301: [248, 239, 238, 218, 246, 241, 211, 210, 240, 249, 244, 216, 245, 212, 209, 250, 251, 202, 243, 242, 201, 203, 247, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 217, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276],

    # 302: Bateria ważna, ale nie najważniejsza
    # Algorytm: Telefony z dobrą baterią, ale też dobrą ogólną specyfikacją.
    302: [241, 246, 218, 243, 239, 238, 211, 210, 240, 201, 203, 249, 244, 216, 245, 212, 209, 250, 251, 202, 242, 247, 217, 248, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276],

    # 303: Mało ważna bateria
    # Algorytm: Priorytet dla innych cech, np. wydajność, aparat, design – bateria nie jest brana pod uwagę.
    303: [239, 238, 240, 241, 203, 246, 248, 218, 247, 243, 201, 242, 211, 202, 217, 210, 212, 209, 250, 251, 244, 249, 216, 245, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276],
    ...
    402: [224, 216, 217, 218, 253, 252, 219, 220, 222, 223, 225, 228, 229, 230, 231, 235, 236, 239, 240, 241, 246, 250],

    # Mały ekran poniżej 6.5 cala
    403: [201, 203, 206, 207, 208, 209, 210, 212, 213, 214, 215, 234, 242, 244, 245],
    # 501: Selfie
    # Algorytm: Telefony z najlepszym przednim aparatem (wysoka rozdzielczość, autofocus) na początku listy.
    501: [248, 239, 247, 218, 202, 246, 201, 203, 211, 210, 241, 240, 238, 242, 243, 212, 249, 244, 216, 245, 209, 250, 251, 252, 253, 254, 255, 217, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276],

    # 502: Zdjęcia nocne
    # Algorytm: Telefony z najlepszym trybem nocnym i jasnym obiektywem na początku listy.
    502: [239, 248, 247, 218, 202, 246, 211, 217, 253, 252, 201, 203, 248, 210, 241, 240, 238, 242, 243, 212, 249, 244, 216, 245, 209, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276],

    # 503: Wszechstronny aparat
    # Algorytm: Telefony z kilkoma obiektywami, dobrym zoomem, szerokim kątem, makro itd.
    503: [247, 246, 201, 248, 203, 239, 218, 211, 253, 252, 217, 202, 210, 241, 240, 238, 242, 243, 212, 249, 244, 216, 245, 209, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276],

    # 601: 128GB
    # Algorytm: Telefony z minimum 128GB pamięci, najtańsze na początku.
    601: [251, 250, 209, 212, 210, 211, 216, 249, 253, 252, 244, 217, 245, 246, 248, 218, 241, 247, 243, 242, 246, 240, 238, 239, 202, 203, 201, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276],

    # 602: 256GB
    # Algorytm: Telefony z minimum 256GB pamięci, najtańsze na początku.
    602: [245, 246, 248, 218, 241, 253, 252, 247, 243, 242, 246, 240, 238, 239, 202, 203, 201, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276, 251, 250, 209, 212, 210, 211, 216, 249, 244, 217],

    # 603: 512GB+
    # Algorytm: Telefony z minimum 512GB pamięci lub więcej, od najtańszego do najdroższego.
    603: [ 239, 238, 240, 246, 201, 241, 247, 243, 242, 203, 218, 248, 246, 245, 244, 249, 216, 211, 210, 212, 209, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276, 217 ],

    # 701: Top wydajność
    # Algorytm: Telefony z najlepszym SoC, największą ilością RAM, najnowszymi technologiami.
    701: [248, 201, 239, 238, 240, 246, 202, 241, 218, 211, 203, 210, 242, 243, 247, 212, 249, 244, 216, 245, 209, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 217, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276],

    # 702: Wysoka wydajność do gier
    # Algorytm: Tak jak wyżej, z naciskiem na GPU i szybkie ekrany.
    702: [239, 238, 240, 246, 202, 241, 248, 218, 211, 217, 210, 242, 201, 252, 253, 243, 247, 212, 249, 244, 203, 216, 245, 209, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276],

    # 703: Standardowa wydajność
    # Algorytm: Telefony z podstawowym, ale stabilnym SoC, niższa cena.
    703: [251, 250, 209, 212, 210, 211, 216, 249, 244, 217, 245, 246, 248, 218, 241, 247, 243, 242, 246, 252, 253, 240, 238, 239, 202, 203, 201, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276],

    # 801: Android
    # Algorytm: Wszystkie telefony z Androidem na początku listy.
    801: [239, 248, 238, 240, 241, 246, 218, 247, 243, 242, 211, 217, 212, 250, 251, 244, 249, 216, 245, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276],

    # 802: iOS
    # Algorytm: Wszystkie telefony Apple na początku listy.
    802: [201, 202, 203, 239, 248, 238, 240, 241, 246, 218, 247, 243, 242, 211, 217, 210, 212, 209, 250, 251, 244, 249, 216, 245, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276],
    ...
    902: [243, 248, 253, 203, 252, 202, 210, 242, 244, 245, 201, 246, 249, 211, 212, 241, 240, 216, 209, 218, 217, 239, 247, 238, 250, 251],

    # 903: Jakość zdjęć nocnych
    # Algorytm: Telefony z najlepszym trybem nocnym i dużą matrycą na początku.
    903: [201, 203, 239, 202, 252, 253, 246, 218, 248, 247, 243, 242, 211, 217, 210, 241, 240, 238, 212, 249, 244, 216, 245, 209, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276],

    # 1001: Samsung
    # Algorytm: Wszystkie telefony marki Samsung na początku.
    1001: [248, 245, 246, 240, 238, 239, 241, 247, 243, 242, 218, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276, 250, 251, 209, 212, 211, 216, 249, 244, 217],
    ...
    1003: [248, 245, 252, 253, 246, 240, 238, 239, 241, 247, 243, 242, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276, 250, 251, 249, 244],

    # 1101: Bardzo ważne szybkie ładowanie
    # Algorytm: Telefony z najszybszym ładowaniem na początku listy.
    1101: [239, 248, 238, 243, 252 ,253  246, 218, 241, 247, 242, 211, 217, 210, 240, 201, 203, 249, 244, 216, 245, 212, 209, 250, 251, 202, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276],

    # 1102: Neutralne szybkie ładowanie
    # Algorytm: Telefony z szybkim (ale nie topowym) ładowaniem na początku.
    1102: [241, 246, 252, 253, 218, 239, 238, 248, 211, 217, 210, 240, 201, 203, 249, 244, 216, 245, 212, 209, 250, 251, 202, 243, 242, 247, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276],
