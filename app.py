...
answers_db = {
   ...
   701: {'question_id': 7, 'next_question_id': 8, 'en': 'I need the highest possible performance', 'es': 'Necesito el máximo rendimiento posible', 'pl': 'Potrzebuję najwyższej wydajności', 'icon_path': 'icons/performance.svg'},
    702: {'question_id': 7, 'next_question_id': 8, 'en': 'I need high performance for gaming', 'es': 'Necesito alto rendimiento para juegos', 'pl': 'Potrzebuję wysokiej wydajności w grach', 'icon_path': 'icons/gamepad.svg'},
    703: {'question_id': 7, 'next_question_id': 8, 'en': 'Standard performance is enough for less demanding games', 'es': 'El rendimiento estándar es suficiente para juegos menos exigentes', 'pl': 'Wystarczy mi standardowa wydajność w mniej wymagających tytułach', 'icon_path': 'icons/ok.svg'},
...
paths_db = {
    (101,201,301,401,1101): [201, 202, 407],
    (101,202,301,401,1101): [407, 305, 306],
