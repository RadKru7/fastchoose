...
answers_x_products = {
    ...
    102: [211, 210, 216, 249, 244, 212, 209, 251, 250, 245, 246, 248, 218, 255, 241, 247, 243, 242, 246, 240, 238, 239, 202, 203, 201, 252, 253, 254,253, 252],

    # 103: Najdroższe telefony
    # Algorytm: Telefony posortowane malejąco po cenie – najdroższy jako pierwszy, najtańszy jako ostatni.
    103: [243, 239, 248, 238, 253, 252, 240, 246, 242, 247, 241, 256, 218, 246, 245, 201, 203, 202, 244, 249, 216, 211, 210, 212, 209, 250, 251, 252, 253, 254,217],

    # 201: Dzwonienie/SMS
    # Algorytm: Telefony z najprostszą obsługą, dobrą baterią, solidnością i niską ceną na początku listy.
    201: [251, 250, 209, 212, 210, 211, 216, 249, 244, 255, 217, 245, 246, 248, 218, 241, 247, 243, 242, 246, 240, 238, 239, 202, 203, 201, 252, 253, 254 ],
    ...
    202: [239, 248, 247, 218, 243, 253, 252, 202, 246, 211, 201, 203, 210, 241, 240, 238, 242, 212, 249, 255, 244, 216, 245, 209, 250, 251, 252, 253, 254,217],

    # 203: Gry (wydajność)
    # Algorytm: Telefony z najmocniejszym procesorem, najlepszym GPU, dużą pamięcią RAM i szybkim ekranem na początku listy.
    203: [239, 248, 238, 240, 246, 202, 241, 218, 211, 201, 203, 210, 242, 243, 247, 212, 249, 244, 216, 245, 253, 252, 209, 250, 251, 252, 253, 254, 217, 255],

    # 301: Bateria bardzo ważna
    # Algorytm: Telefony z największą pojemnością baterii i najlepszą optymalizacją na początku listy.
    301: [248, 239, 238, 218, 246, 241, 211, 210, 240, 249,255, 244, 216, 245, 212, 209, 250, 251, 202, 243, 242, 201, 203, 247, 252, 253, 254,217],
    ...
    303: [239, 238, 240, 241, 203, 246, 248, 218, 247, 243, 201, 256, 242, 211, 202, 217, 210, 212, 209, 250, 251, 244, 249, 216, 245, 252, 253, 254],
    ...
    402: [224, 216, 217, 218, 253, 252, 219, 256, 220, 255, 222, 223, 225, 228, 229, 230, 231, 235, 236, 239, 240, 241, 246, 250],
    ...
    501: [248, 239, 247, 218, 202, 246, 201, 203, 211, 210, 241, 240, 238, 242, 243, 212, 249, 244, 216, 245, 209, 250, 251, 252, 253, 254, 217],

    # 502: Zdjęcia nocne
    # Algorytm: Telefony z najlepszym trybem nocnym i jasnym obiektywem na początku listy.
    502: [239, 248, 247, 218, 256, 202, 246, 211, 217, 253, 252, 201, 203, 248, 210, 241, 240, 238, 242, 243, 212, 249, 244, 216, 245, 209, 250, 251, 252, 253, 254],

    # 503: Wszechstronny aparat
    # Algorytm: Telefony z kilkoma obiektywami, dobrym zoomem, szerokim kątem, makro itd.
    503: [247, 246, 201, 248, 203, 239, 256, 218, 211, 253, 252, 217, 202, 210, 241, 240, 238, 255, 242, 243, 212, 249, 244, 216, 245, 209, 250, 251, 252, 253, 254],

    # 601: 128GB
    # Algorytm: Telefony z minimum 128GB pamięci, najtańsze na początku.
    601: [251, 250, 209, 212, 210, 211, 255, 216, 249, 253, 252, 244, 217, 245, 246, 248, 218, 241, 247, 243, 242, 246, 240, 238, 239, 202, 203, 201, 252, 253, 254,],

    # 602: 256GB
    # Algorytm: Telefony z minimum 256GB pamięci, najtańsze na początku.
    602: [245, 246, 248, 218, 256, 241, 253, 252,255, 247, 243, 242, 246, 240, 238, 239, 202, 203, 201, 252, 253, 254, 251, 250, 209, 212, 210, 211, 216, 249, 244, 217],

    # 603: 512GB+
    # Algorytm: Telefony z minimum 512GB pamięci lub więcej, od najtańszego do najdroższego.
    603: [ 239, 238,256, 240, 246, 201, 241, 247,255, 243, 242, 203, 218, 248, 246, 245, 244, 249, 216, 211, 210, 212, 209, 250, 251, 252, 253, 254,217],
    ...
    702: [239, 238, 240, 246, 202, 241, 248, 218, 211, 217, 210, 256, 242, 201, 252, 253, 243, 247, 212, 249, 244, 203, 216,255, 245, 209, 250, 251, 252, 253, 254,251],
    ...
    801: [239, 248, 238, 240, 241, 246,256, 255, 218, 247, 243, 242, 211, 217, 212, 254, 250, 251, 244, 249, 216, 245, 252, 253, 254],
    ...
    902: [243, 248, 253, 203, 252, 202, 210, 242, 244, 255,256, 245, 201, 246, 249, 211, 212, 241, 240, 216, 209, 218, 217, 239, 247, 238, 250, 251],

    # 903: Jakość zdjęć nocnych
    # Algorytm: Telefony z najlepszym trybem nocnym i dużą matrycą na początku.
    903: [201, 203, 239, 202, 252, 253, 246, 218, 248, 247,256, 243, 242, 211, 217, 210, 241, 240, 238, 212, 249, 244, 216, 245, 209, 250, 251, 252, 253, 254,],

    # 1001: Samsung
    # Algorytm: Wszystkie telefony marki Samsung na początku.
    1001: [248, 245, 246, 240, 238, 239, 241, 247, 243, 242, 218, 252, 253, 254, 250, 251, 209, 212, 211, 216, 249, 244, 217],
    ...
    1101: [239, 248, 238, 243, 252 ,253  246,256, 218, 241, 247, 242, 211, 217, 210, 240, 201, 203, 249, 244, 216, 245, 212, 209, 250, 251, 202, 252, 253, 254],

    # 1102: Neutralne szybkie ładowanie
    # Algorytm: Telefony z szybkim (ale nie topowym) ładowaniem na początku.
    1102: [241, 246, 252, 253, 218, 239, 238, 248, 211, 217, 210, 240, 201,256, 203, 249, 244, 216, 245, 212, 209, 250, 251, 202, 243, 242, 247, 252, 253, 254],
